# Generated by Powerlevel10k configuration wizard on 2023-10-04 at 21:30 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
   ...
   #vcs                     # git status (disabled since its already present in tmux bar)
    status                  # exit code of the las command
    command_execution_time  # command execution time of last command
