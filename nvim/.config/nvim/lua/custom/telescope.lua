return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>sc", builtin.git_commits, { desc = "[S]earch [c]ommits in current repository" })
        vim.keymap.set("n", "<leader>sC", builtin.git_bcommits, { desc = "[S]earch [C]ommits in current buffer" })
